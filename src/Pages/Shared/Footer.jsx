    ...
    <footer className="relative bg-gradient-to-t from-[#0b1320] via-[#111b2f] to-[#0b1320] text-white pt-16 pb-12 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col gap-10">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-lg hover:scale-105 transition-transform duration-500 animate-wave">
          <h2 className="text-2xl md:text-3xl font-bold mb-3">Bheramara Fiber Link</h2>
          <p className="text-gray-200 leading-relaxed mb-2 text-sm md:text-base">📌 Ground Floor, Khan Super Market, Bheramara, Kushtia.</p>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-6 shadow-lg hover:scale-105 transition-transform duration-500 flex flex-wrap justify-center gap-4 md:gap-6 animate-wave">
          {[
            { icon: <Facebook className="w-5 md:w-6 h-5 md:h-6" />, username: "@bheramara-fiber-link", color: "hover:text-blue-600" },
            { icon: <Instagram className="w-5 md:w-6 h-5 md:h-6" />, username: "@bheramara-fiber-link", color: "hover:text-pink-400" },
            { icon: <Twitter className="w-5 md:w-6 h-5 md:h-6" />, username: "@bheramara-fiber-link", color: "hover:text-blue-400" },
            { icon: <Linkedin className="w-5 md:w-6 h-5 md:h-6" />, username: "@bheramara-fiber-link", color: "hover:text-blue-500" },
          ].map((social, idx) => (
            <a
              key={idx}
              href="#"
      ...
      <div className="mt-12 text-center text-gray-400 text-xs md:text-sm animate-wave">
        &copy; {new Date().getFullYear()} Bheramara Fiber Link. All rights reserved.
      </div>
