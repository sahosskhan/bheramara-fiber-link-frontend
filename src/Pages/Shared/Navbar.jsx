...
const Navbar = () => {
  const menuItems = [
    ...
    { name: "FTP Server", path: "/ftp-server" },
...
<div className="navbar-start flex items-center gap-3">
  ...
  {/* Logo + Unique Name */}
  <section
    className="flex items-center px-2 rounded-xl bg-white/90 shadow-md"
  >
    <img
      src="/logo.png" // replace with your actual logo
      alt="SSN Logo"
      className="lg:w-28 lg:h-20 h-14 w-16  object-contain rounded-full"
    />
  </section>
</div>
