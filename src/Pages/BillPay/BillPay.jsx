...
const BillPay = () => {
  ...
  const instructions = [
    ...
    "Include your conatct number and user id in the reference.",
    ...
    <div className="bg-gradient-to-br from-[#0e1026] via-[#1f0b3a] to-[#0b253e] text-gray-100 min-h-screen px-6 py-16">
      ...
      <section className="text-center pb-10">
        ...
        <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto animate-fadeIn delay-200">
          Pay your BFL Internet bill using your preferred mobile banking method.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-lg mt-12 animate-fadeIn delay-600">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {instructions.map((inst, index) => (
            ...
            >
              <ul className=" text-gray-300 text-lg  text-left">
                <li>🔰{inst}</li>
              </ul>
            </div>
          ))}
